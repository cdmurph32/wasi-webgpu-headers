...
typedef struct {
  ...
  bool f1;
} command_tuple2_list_u8_bool_t;

typedef struct {
  bool is_err;
  union {
    command_tuple2_list_u8_bool_t ok;
    wasi_filesystem_types_error_code_t err;
  } val;
...
extern bool wasi_cli_environment_initial_cwd(command_string_t *ret);
...
// hazard.
extern void wasi_io_error_method_error_to_debug_string(wasi_io_error_borrow_error_t self, command_string_t *ret);
...
extern void wasi_io_poll_poll(wasi_io_poll_list_borrow_pollable_t *in, command_list_u32_t *ret);
...
extern bool wasi_io_streams_method_input_stream_read(wasi_io_streams_borrow_input_stream_t self, uint64_t len, command_list_u8_t *ret, wasi_io_streams_stream_error_t *err);
// Read bytes from a stream, after blocking until at least one byte can
// be read. Except for blocking, behavior is identical to `read`.
extern bool wasi_io_streams_method_input_stream_blocking_read(wasi_io_streams_borrow_input_stream_t self, uint64_t len, command_list_u8_t *ret, wasi_io_streams_stream_error_t *err);
...
extern bool wasi_io_streams_method_output_stream_write(wasi_io_streams_borrow_output_stream_t self, command_list_u8_t *contents, wasi_io_streams_stream_error_t *err);
...
// ```
extern bool wasi_io_streams_method_output_stream_blocking_write_and_flush(wasi_io_streams_borrow_output_stream_t self, command_list_u8_t *contents, wasi_io_streams_stream_error_t *err);
...
extern bool wasi_filesystem_types_method_descriptor_read(wasi_filesystem_types_borrow_descriptor_t self, wasi_filesystem_types_filesize_t length, wasi_filesystem_types_filesize_t offset, command_tuple2_list_u8_bool_t *ret, wasi_filesystem_types_error_code_t *err);
...
extern bool wasi_filesystem_types_method_descriptor_write(wasi_filesystem_types_borrow_descriptor_t self, command_list_u8_t *buffer, wasi_filesystem_types_filesize_t offset, wasi_filesystem_types_filesize_t *ret, wasi_filesystem_types_error_code_t *err);
...
extern bool wasi_filesystem_types_method_descriptor_create_directory_at(wasi_filesystem_types_borrow_descriptor_t self, command_string_t *path, wasi_filesystem_types_error_code_t *err);
...
extern bool wasi_filesystem_types_method_descriptor_stat_at(wasi_filesystem_types_borrow_descriptor_t self, wasi_filesystem_types_path_flags_t path_flags, command_string_t *path, wasi_filesystem_types_descriptor_stat_t *ret, wasi_filesystem_types_error_code_t *err);
...
extern bool wasi_filesystem_types_method_descriptor_link_at(wasi_filesystem_types_borrow_descriptor_t self, wasi_filesystem_types_path_flags_t old_path_flags, command_string_t *old_path, wasi_filesystem_types_borrow_descriptor_t new_descriptor, command_string_t *new_path, wasi_filesystem_types_error_code_t *err);
...
extern bool wasi_filesystem_types_method_descriptor_readlink_at(wasi_filesystem_types_borrow_descriptor_t self, command_string_t *path, command_string_t *ret, wasi_filesystem_types_error_code_t *err);
// Remove a directory.
// 
// Return `error-code::not-empty` if the directory is not empty.
// 
// Note: This is similar to `unlinkat(fd, path, AT_REMOVEDIR)` in POSIX.
extern bool wasi_filesystem_types_method_descriptor_remove_directory_at(wasi_filesystem_types_borrow_descriptor_t self, command_string_t *path, wasi_filesystem_types_error_code_t *err);
// Rename a filesystem object.
// 
// Note: This is similar to `renameat` in POSIX.
extern bool wasi_filesystem_types_method_descriptor_rename_at(wasi_filesystem_types_borrow_descriptor_t self, command_string_t *old_path, wasi_filesystem_types_borrow_descriptor_t new_descriptor, command_string_t *new_path, wasi_filesystem_types_error_code_t *err);
...
extern bool wasi_filesystem_types_method_descriptor_symlink_at(wasi_filesystem_types_borrow_descriptor_t self, command_string_t *old_path, command_string_t *new_path, wasi_filesystem_types_error_code_t *err);
// Unlink a filesystem object that is not a directory.
// 
// Return `error-code::is-directory` if the path refers to a directory.
// Note: This is similar to `unlinkat(fd, path, 0)` in POSIX.
extern bool wasi_filesystem_types_method_descriptor_unlink_file_at(wasi_filesystem_types_borrow_descriptor_t self, command_string_t *path, wasi_filesystem_types_error_code_t *err);
...
extern bool wasi_filesystem_types_method_descriptor_metadata_hash_at(wasi_filesystem_types_borrow_descriptor_t self, wasi_filesystem_types_path_flags_t path_flags, command_string_t *path, wasi_filesystem_types_metadata_hash_value_t *ret, wasi_filesystem_types_error_code_t *err);
...
extern bool wasi_sockets_ip_name_lookup_resolve_addresses(wasi_sockets_ip_name_lookup_borrow_network_t network, command_string_t *name, wasi_sockets_ip_name_lookup_own_resolve_address_stream_t *ret, wasi_sockets_ip_name_lookup_error_code_t *err);
...
// data.
extern void wasi_random_random_get_random_bytes(uint64_t len, command_list_u8_t *ret);
...
// a long period.
extern void wasi_random_insecure_get_insecure_random_bytes(uint64_t len, command_list_u8_t *ret);
...
// protection.
extern void wasi_random_insecure_seed_insecure_seed(command_tuple2_u64_u64_t *ret);
